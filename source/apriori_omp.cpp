...
int main()
{
    ...
    double codeStartTime = omp_get_wtime();
    ...
    #pragma omp parallel
    {
        ...
        for (int i = 0; i <= aNumProducts; i++)
        {
            ...
            aSupportProducts[i] = round(100 * (iProductFrequency) 
									/ aNumTransactions);
    ...
    double codeFinishTime = omp_get_wtime();
    double codeDuration = ((double)(codeFinishTime - codeStartTime));
